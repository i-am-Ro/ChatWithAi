    ...
    return (
        <div className="project-container">
            <div className="header">
                 <button onClick={() => navigate('/dashboard')} className="secondary">&larr; Back to Dashboard</button>
                 <h2 style={{marginLeft: '20px', display: 'inline'}}>Chat Interface</h2>
            </div>

            {/* Chat Interface - Full Width */}
            <div className="card" style={{ height: 'calc(100vh - 150px)', display: 'flex', flexDirection: 'column' }}>
                <div className="chat-window" style={{ flex: 1, border: 'none', padding: '20px 0' }}>
